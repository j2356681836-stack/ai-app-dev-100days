...
CASES = (
    ...
    Case(
        ...
        expected_source=TimeWindowResolutionSourceV2.EXPLICIT,
        expected_type=TimeExpressionTypeV2.EXPLICIT_MONTH,
        requested_start=date(2025, 10, 1),
        requested_end=date(2025, 10, 31),
        effective_start=date(2025, 10, 1),
        effective_end=date(2025, 10, 31),
    ),
    Case(
        "TWV2-021",
        "2025 年 10 月GMV是多少？",
    ...
    Case(
        "TWV2-023",
        "2025 年 1 月 1 日 至 2025 年 1 月 31 日GMV是多少？",
        TimeWindowResolutionStatusV2.RESOLVED,
        expected_source=TimeWindowResolutionSourceV2.EXPLICIT,
        expected_type=TimeExpressionTypeV2.EXPLICIT_DATE_RANGE,
        requested_start=date(2025, 1, 1),
        ...
        effective_start=date(2025, 1, 1),
        effective_end=date(2025, 1, 31),
    ),
    Case(
        "TWV2-024",
        "20 255年GMV是多少？",
        TimeWindowResolutionStatusV2.UNSUPPORTED,
    ),
)
